...
public class IdeaServiceImpl implements IdeaService {
    ...
    @Value("${ideaPosted.rabbitmq.exchange}")
    public String exchangeIdea;

    @Value("${ideaPosted.rabbitmq.routingkey}")
    public String routingkeyIdea;
    ...
    public Idea save(Idea idea) throws IdeaAlreadyExistException {
        ...
        rabbitTemplate.convertAndSend(exchangeIdea,routingkeyIdea,idea);
